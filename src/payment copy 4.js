...
function RazorpayPaymentcharlie() {
  ...
  const getDataByUniqueId = () => {
    ...
    if (!isNaN(uniqueIdNumber)) {
      const collectionRef = db.collection("charlie");
  ...
  return (
    <div className="container" style={{ textAlign: "center" }}>
      <div className="card" style={{textAlign:"center"}}>
        <h2 style={{ color: 'black', textAlign: "center" }}>READ DATA CHARLIE</h2>
...
export default RazorpayPaymentcharlie;
