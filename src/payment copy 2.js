...
function RazorpayPaymentbeta() {
  ...
  const getDataByUniqueId = () => {
    ...
    if (!isNaN(uniqueIdNumber)) {
      const collectionRef = db.collection("beta");
  ...
  return (
    <div className="container" style={{ textAlign: "center" }}>
      <div className="card" style={{textAlign:"center"}}>
        <h2 style={{ color: 'blcak', textAlign: "center" }}>READ DATA BETA</h2>
...
export default RazorpayPaymentbeta;
